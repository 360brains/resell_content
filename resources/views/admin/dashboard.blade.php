...
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar1.jpg') }}" /> </div>--}}
...
{{--                                        <div class="mt-comment">--}}
{{--                                            <div class="mt-comment-img">--}}
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar6.jpg') }}" /> </div>--}}
{{--                                            <div class="mt-comment-body">--}}
{{--                                                <div class="mt-comment-info">--}}
...
{{--                                        <div class="mt-comment">--}}
{{--                                            <div class="mt-comment-img">--}}
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar8.jpg') }}" /> </div>--}}
{{--                                            <div class="mt-comment-body">--}}
{{--                                                <div class="mt-comment-info">--}}
...
{{--                                        <div class="mt-comment">--}}
{{--                                            <div class="mt-comment-img">--}}
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar4.jpg') }}" /> </div>--}}
{{--                                            <div class="mt-comment-body">--}}
{{--                                                <div class="mt-comment-info">--}}
...
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar10.jpg') }}" /> </div>--}}
...
{{--                                        <div class="mt-action">--}}
{{--                                            <div class="mt-action-img">--}}
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar3.jpg') }}" /> </div>--}}
{{--                                            <div class="mt-action-body">--}}
{{--                                                <div class="mt-action-row">--}}
{{--                                                    <div class="mt-action-info ">--}}
{{--                                                        <div class="mt-action-icon ">--}}
...
{{--                                        <div class="mt-action">--}}
{{--                                            <div class="mt-action-img">--}}
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar2.jpg') }}" /> </div>--}}
{{--                                            <div class="mt-action-body">--}}
{{--                                                <div class="mt-action-row">--}}
{{--                                                    <div class="mt-action-info ">--}}
{{--                                                        <div class="mt-action-icon ">--}}
...
{{--                                        <div class="mt-action">--}}
{{--                                            <div class="mt-action-img">--}}
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar7.jpg') }}" /> </div>--}}
{{--                                            <div class="mt-action-body">--}}
{{--                                                <div class="mt-action-row">--}}
{{--                                                    <div class="mt-action-info ">--}}
{{--                                                        <div class="mt-action-icon ">--}}
...
{{--                                        <div class="mt-action">--}}
{{--                                            <div class="mt-action-img">--}}
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar9.jpg') }}" /> </div>--}}
{{--                                            <div class="mt-action-body">--}}
{{--                                                <div class="mt-action-row">--}}
{{--                                                    <div class="mt-action-info ">--}}
{{--                                                        <div class="mt-action-icon ">--}}
...
{{--                                        <div class="mt-action">--}}
{{--                                            <div class="mt-action-img">--}}
{{--                                                <img src="{{ asset('admin/assets/pages/media/users/avatar5.jpg') }}" /> </div>--}}
{{--                                            <div class="mt-action-body">--}}
{{--                                                <div class="mt-action-row">--}}
{{--                                                    <div class="mt-action-info ">--}}
{{--                                                        <div class="mt-action-icon ">--}}
...
{{--                                    <tr>--}}
{{--                                        <td class="fit">--}}
{{--                                            <img class="user-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar4.jpg') }}"> </td>--}}
{{--                                        <td>--}}
...
{{--                                    <tr>--}}
{{--                                        <td class="fit">--}}
{{--                                            <img class="user-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar5.jpg') }}"> </td>--}}
{{--                                        <td>--}}
...
{{--                                    <tr>--}}
{{--                                        <td class="fit">--}}
{{--                                            <img class="user-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar6.jpg') }}"> </td>--}}
{{--                                        <td>--}}
...
{{--                                    <tr>--}}
{{--                                        <td class="fit">--}}
{{--                                            <img class="user-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar7.jpg') }}"> </td>--}}
{{--                                        <td>--}}
...
{{--                                                <img class="item-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar4.jpg') }}">--}}
...
{{--                                        <div class="item-head">--}}
{{--                                            <div class="item-details">--}}
{{--                                                <img class="item-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar3.jpg') }}">--}}
...
{{--                                        <div class="item-head">--}}
{{--                                            <div class="item-details">--}}
{{--                                                <img class="item-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar6.jpg') }}">--}}
{{--                                                <a href="" class="item-name primary-link">Nick Larson</a>--}}
...
{{--                                        <div class="item-head">--}}
{{--                                            <div class="item-details">--}}
{{--                                                <img class="item-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar7.jpg') }}">--}}
{{--                                                <a href="" class="item-name primary-link">Nick Larson</a>--}}
...
{{--                                        <div class="item-head">--}}
{{--                                            <div class="item-details">--}}
{{--                                                <img class="item-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar9.jpg') }}">--}}
...
{{--                                        <div class="item-head">--}}
{{--                                            <div class="item-details">--}}
{{--                                                <img class="item-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar8.jpg') }}">--}}
...
{{--                                        <div class="item-head">--}}
{{--                                            <div class="item-details">--}}
{{--                                                <img class="item-pic rounded" src="{{ asset('admin/assets/pages/media/users/avatar2.jpg') }}">--}}
...
{{--                                <img src="{{ asset('admin/assets/global/img/loading.gif') }}" alt="loading" /> </div>--}}
