...
@section('content')
    ...
    <h3 class="page-title">Membership
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        <input type="text" name="name" class="form-control" id="form_control_1" placeholder="Enter Membership Name" value="{{old('name')}}">
                                        <label>Membership Name</label>
                                    </div>

                                    <div class="form-group form-md-line-input">
                                        <input type="number" name="price" class="form-control" id="mask_number form_control_1" placeholder="Enter Price for Membership" value="{{old('price')}}">
                                        <label>Membership Price</label>
                                    </div>

                                    <div class="form-group form-md-line-input">
                                        <input type="number" name="duration" class="form-control" id="mask_number form_control_1" placeholder="Enter Duration for Membership" value="{{old('duration')}}">
