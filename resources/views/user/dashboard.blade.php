    ...
    <div class="container">
                ...
                <div class="content-area card p-2 border-0 shadow">
                    <div class="card-innr video-making-card">
                        ...
                        <div class="card-head d-inline" style="font-size: 19px">
                            <h6 class="d-inline card-title">
                                <srtong>Raise your Level:</srtong>
                            </h6>
                            <small>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="recent-projects shadow rounded">
                    <div class="clearfix">
                        <strong>
                            <h5 class="float-left">RECENT PROJECTS</h5>
                        </strong>
            ...
            <div class="col-md-4">
                <div class="profile shadow rounded">
                    ...
                    <div class="profile-dec pt-3">
                        <h6>CONTENT WRITING <span class="badge">{{ auth()->user()->writing_level }}</span></h6>
                        <div class="clearfix">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="progress d-inline-flex" style="height: 5px; width: 165px;">
                                <div class="progress-bar bg-success" data-percent=" {{ auth()->user()->writing_points }}" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <h6 class="float-right">{{ auth()->user()->writing_points }}</h6>
                        </div>
                        <h6 class="pt-2">VIDEO CONTENT <span class="badge">{{ auth()->user()->video_level }}</span></h6>
                        <div class="clearfix">
                        ...
                        <div class="clearfix">
                            <p class="float-left pr-3">Points Earned</p>
                            <div class="progress d-inline-flex" style="height: 5px; width: 165px;">
                                <div class="progress-bar bg-success" data-percent=" {{ auth()->user()->video_points }}" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
