            ...
            <div class="col-xl-4 col-lg-5">
                <div class="token-sales card card-full-height">
                    <div class="card-innr">
                        ...
                        <div class="profile-name float-left pl-3">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="token-sales card card-full-height">
                <div class="card-innr">
                    ...
                    <h6 class="text-light d-inline text-uppercase"><i class="far fa-edit"></i> Content Writing</h6>
                    <div class="pro d-inline">
                        <button class="float-right btn btn-xs btn-primary ">Professional</button>
                    </div>
                    <ul class="progress-info pt-2">
                    ...
                    <h6 class="text-light d-inline text-uppercase"><i class="far fa-play-circle"></i> Video Making</h6>
                    <div class="pro d-inline">
                        <button class="float-right btn btn-xs btn-primary ">Basic</button>
                    </div>
