                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="referal text-center shadow">
                        ...
                        <div class="copy-wrap mgb-0-5x"><span class="copy-feedback"></span><img class="link" width="24px" src="{{ asset('user/images/refer-2.png') }}" alt="">
                            <input type="text" class="copy-address shadow-sm" value="http://cvf.sunztech.com/register?id={{auth()->user()->id}}" disabled>
                            <button class="copy-trigger copy-clipboard" data-clipboard-text="http://cvf.sunztech.com/register?id={{auth()->user()->id}}"><img width="24px" src="{{ asset('user/images/refer-1.png') }}" alt="">
                            </button>
                        </div>
                    </div>
                </div>
