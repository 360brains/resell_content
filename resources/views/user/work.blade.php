                            ...
                            <div class="card-head">
                                <form action="{{ route('user.tasks.save.progress', $task->id) }}" method="post">
                                    ...
                                    <ul class="work-submit">
                                        <li>
                                            <button class="btn btn-auto btn-lg btn-success" type="submit"><em class="fas fa-download"></em>
                                                Save Progress </button>
                                        </li>
                                        <div class="my-work-btn" >
                                            <li><a href="#" class="btn btn-auto btn-lg btn-danger"><em class="fas fa-upload"></em> Submit </a></li>
                                        </div>
