                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="clearfix">
                                ...
                                @if( $minutes <= 60 && $hours==0 && $day==0) <a href="#" data-toggle="modal" data-target="#extend-time" class="badge btn btn-info btn-xs">Request time
                                    extension</a>
                                    @endif
                                    @endif
                            </div>
                        ...
                        <div class="col-md-5 ">
                            ...
                            {{-- <ul class="btn-grp">--}}
                            {{-- <li><a href="{{ route('user.tasks.create.doc', $task->id) }}"
                            class="btn btn-auto btn-sm btn-success"><em class="fas fa-download"></em> Download</a></li>
                            --}}
                            {{-- </ul>--}}
                        ...
                        <div class="card-head">
                            <form action="{{ route('user.tasks.save.progress', $task->id) }}" method="post">
                                ...
                                <ul class="clearfix pt-3">
                                    <li class="float-left">
                                        <button class="button button-primary button-icon button-icon-left button-anorak rd-navbar-popup-toggle" type="submit" name="action" value="save"><em class="fas fa-download"></em>
                                            Save Progress
                                        </button>
                                    </li>
                                    <div class="my-work-btn float-right">
                                        <li>
                                            <button class="button button-primary-outline button-icon button-icon-left button-anorak " name="action" value="submit"><em class="fas fa-upload"></em>
                                                Submit
                                            </button>
                                        </li>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="clearfix">
                                ...
                                @if(is_null($task->timeExtension))
                                @if( $minutes <= 60 && $hours==0 && $day==0) <a href="#" data-toggle="modal" data-target="#extend-time" class="btn btn-info btn-xs">Request time extension</a>
                                    @endif
                                    @endif
                            </div>
                        </div>
                            ...
                            <div class="card-innr">
                                ...
                                <div class="clearfix">
                                    <form action="{{ route('user.tasks.save.progress', $task->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" name="action" value="video" class="btn float-right btn-outline-success"><em class="fas fa-upload"></em>
                                            Submit</button>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="popup-body popup-body-lg">
                            <div class="content-area">
                                <div class="card-head d-flex justify-content-between align-items-center">
                                    <h4 class="card-title pb-2 mb-0">Task Description</h4>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content pb-0">
            ...
            <div class="popup-body">
                ...
                <p class="lead">To get time extesion, you must give a valid reason to convince the administrator to
                    extend your time.</p>
                ...
                <form action="{{ route('user.tasks.extend', $task->id) }}">
                    ...
                    <div class="input-item input-with-label pdb-2-5x pdt-1-5x pt-3 pb-3">
                        <label for="number" class="input-item-label">Time extension needed <small>(in hours B/W 1 -
                                48)</small>.</label>
